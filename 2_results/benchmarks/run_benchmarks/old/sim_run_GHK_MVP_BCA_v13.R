...
#           
#           try({
#               source("/home/enzo/Documents/Work/PhD_work/R_packages/BayesMVP/R/BayesMVP_fn_GHK_MVP_BCA_v10.R") 
#           }, silent = TRUE)
#           try({
#               source("/home/enzocerullo/Documents/Work/PhD_work/R_packages/BayesMVP/R/BayesMVP_fn_GHK_MVP_BCA_v10.R")
#           }, silent = TRUE )
#           
#      
# }
...
#             #   run_type = "pilot_target_ESS"
#             #   run_type = "pilot_runs_1" # stages 1 and 2 (+ stage 3 ???) # 
#             #   run_type = "pilot_runs_2" # stage 3
#             #   run_type = "final_runs"
#            
   ...
   if (N == 25000)         L_main_if_manual = 24   # N =   
  ...
  
        {
          ...
          #  n_chains_vec <- c(32, 64) ;    n_chains_burnin_vec <- c(8, 16)
           ...
           if (run_type == "pilot_runs_1") {  # using 16 chains + 10 runs each 
             
                 if (N < 5001) {
                   
                   n_chains_vec <- c(32) ;      n_chains_burnin_vec <- c(32, 16, 8)    ;   n_burnin_vec <- c(125) ;    lr_vec <- c(0.05, 0.10, 0.15)  ; adapt_width_type_vec = c("medium")
                   n_chains_vec <- c(32) ;      n_chains_burnin_vec <- c(32, 16, 8)    ;   n_burnin_vec <- c(250) ;    lr_vec <- c(0.05, 0.10      )  ; adapt_width_type_vec = c("medium")
                   n_chains_vec <- c(32) ;      n_chains_burnin_vec <- c(32, 16, 8)    ;   n_burnin_vec <- c(500) ;    lr_vec <- c(0.05            )  ; adapt_width_type_vec = c("medium")
                   
                   n_chains_vec <- c(16) ;      n_chains_burnin_vec <- c(16)    ;   n_burnin_vec <- c(125) ;    lr_vec <- c(0.05, 0.10, 0.15)  ; adapt_width_type_vec = c("medium")
                   n_chains_vec <- c(16) ;      n_chains_burnin_vec <- c(16)    ;   n_burnin_vec <- c(250) ;    lr_vec <- c(0.05, 0.10      )  ; adapt_width_type_vec = c("medium")
                   n_chains_vec <- c(16) ;      n_chains_burnin_vec <- c(16)    ;   n_burnin_vec <- c(500) ;    lr_vec <- c(0.05            )  ; adapt_width_type_vec = c("medium")
                   
                   n_chains_vec <- c(8) ;      n_chains_burnin_vec <- c(8)    ;   n_burnin_vec <- c(125) ;    lr_vec <- c(0.05, 0.10, 0.15)  ; adapt_width_type_vec = c("medium")
                   n_chains_vec <- c(8) ;      n_chains_burnin_vec <- c(8)    ;   n_burnin_vec <- c(250) ;    lr_vec <- c(0.05, 0.10      )  ; adapt_width_type_vec = c("medium")
                   n_chains_vec <- c(8) ;      n_chains_burnin_vec <- c(8)    ;   n_burnin_vec <- c(500) ;    lr_vec <- c(0.05            )  ; adapt_width_type_vec = c("medium")
                   
                   
                    #  n_chains_vec <- c(32) ;      n_chains_burnin_vec <- c(16)    ;   n_burnin_vec <- c(125) ;    lr_vec <- c(  0.05)  ; adapt_width_type_vec = c("short")  # 9 configs
                   #  n_chains_vec <- c(32) ;      n_chains_burnin_vec <- c(32, 16, 8)    ;   n_burnin_vec <- c(125) ;    lr_vec <- c(0.05, 0.10, 0.15)  ; adapt_width_type_vec = c("medium")  # 9 configs
                  
                   #   n_chains_vec <- c(32) ;      n_chains_burnin_vec <- c(32, 16, 8)    ;   n_burnin_vec <- c(250) ;    lr_vec <- c(0.05, 0.10)  ; adapt_width_type_vec = c("short")  # 6 configs
                    #  n_chains_vec <- c(32) ;      n_chains_burnin_vec <- c(32, 16, 8)    ;   n_burnin_vec <- c(250) ;    lr_vec <- c(0.05, 0.10)  ; adapt_width_type_vec = c("medium") # 6 configs
                   
                    #    n_chains_vec <- c(32) ;      n_chains_burnin_vec <- c(32, 16, 8)    ;   n_burnin_vec <- c(500) ;    lr_vec <-c(0.05)  ; adapt_width_type_vec = c("short")    # 3 configs 
                   #    n_chains_vec <- c(32) ;      n_chains_burnin_vec <- c(32, 16, 8)    ;   n_burnin_vec <- c(500) ;    lr_vec <- c(0.05)  ; adapt_width_type_vec = c("medium")   # 3 configs
                      
                      
                      
                     ##    n_chains_vec <- c(16) ;      n_chains_burnin_vec <- c(16)    ;   n_burnin_vec <- c(125) ;    lr_vec <- c(  0.05, 0.10, 0.15)  ; adapt_width_type_vec = c("short")   # 3 configs
                     #   n_chains_vec <- c(16) ;      n_chains_burnin_vec <- c(16)    ;   n_burnin_vec <- c(125) ;    lr_vec <- c(0.05, 0.10, 0.15)  ; adapt_width_type_vec = c("medium")  # 3 configs
                      
                      #  n_chains_vec <- c(16) ;      n_chains_burnin_vec <- c(16)    ;   n_burnin_vec <- c(250) ;    lr_vec <- c(0.05, 0.10)  ; adapt_width_type_vec = c("short")  # 2 configs
                       #   n_chains_vec <- c(16) ;      n_chains_burnin_vec <- c(16)    ;   n_burnin_vec <- c(250) ;    lr_vec <- c(0.05, 0.10)  ; adapt_width_type_vec = c("medium")  # 2 configs
                      
                      #    n_chains_vec <- c(16) ;      n_chains_burnin_vec <- c(16)    ;   n_burnin_vec <- c(500) ;    lr_vec <- c(0.05)  ; adapt_width_type_vec = c("short")    # 1 configs 
                       #   n_chains_vec <- c(16) ;      n_chains_burnin_vec <- c(16)    ;   n_burnin_vec <- c(500) ;    lr_vec <- c(0.05)  ; adapt_width_type_vec = c("medium")   # 1 configs
                      
                      
                      
                     #  n_chains_vec <- c(8) ;      n_chains_burnin_vec <- c(8)    ;   n_burnin_vec <- c(125) ;    lr_vec <- c(  0.05, 0.10, 0.15)  ; adapt_width_type_vec = c("short")  #  3 configs
                      #  n_chains_vec <- c(8) ;      n_chains_burnin_vec <- c(8)    ;   n_burnin_vec <- c(125) ;    lr_vec <- c(0.05, 0.10, 0.15)  ; adapt_width_type_vec = c("medium")  # 3 configsc
                      
                       #   n_chains_vec <- c(8) ;      n_chains_burnin_vec <- c(8)    ;   n_burnin_vec <- c(250) ;    lr_vec <- c(0.05, 0.10)  ; adapt_width_type_vec = c("short")  # 2 configs
                      #  n_chains_vec <- c(8) ;      n_chains_burnin_vec <- c(8)    ;   n_burnin_vec <- c(250) ;    lr_vec <- c(0.05, 0.10)  ; adapt_width_type_vec = c("medium")  # 2 configs
                      
                       #     n_chains_vec <- c(8) ;      n_chains_burnin_vec <- c(8)    ;   n_burnin_vec <- c(500) ;    lr_vec <- c(0.05)  ; adapt_width_type_vec = c("short")    # 1 configs 
                     #     n_chains_vec <- c(8) ;      n_chains_burnin_vec <- c(8)    ;   n_burnin_vec <- c(500) ;    lr_vec <- c(0.05)  ; adapt_width_type_vec = c("medium")   # 1 configs
                   
                   n_chains_vec <- c(8) ;      n_chains_burnin_vec <- c(8)    ;   n_burnin_vec <- c(125) ;    lr_vec <- c( 0.15)  ; adapt_width_type_vec = c("short")  #  3 configs
           ...
           } else if (run_type == "pilot_target_ESS") { 
                 ...
                 #  adapt_width_type_vec = c("very_short")  ;  lr_vec <- c(0.05) 
  ...
  
{
  ...
  if  (experiment == "algorithm_binary")  { 
          ...
          if (run_type == "pilot_runs_1") { 
            n_iter =  200 ### 100 ###  50
          } else if  (run_type == "pilot_runs_2")  { # to narrow down / select best settings from pilot study 1
            n_iter =  250 ### 200
          } else if (run_type == "final_runs") {  
            
            ## need to update !!
            if (n_chains == 8) {
                      if (N == 500)      n_iter = 393   
                      if (N == 1000)     n_iter = 529 
                      if (N == 2500)     n_iter = 815  
                      if (N == 5000)     n_iter = 892 
                      if (N == 12500)    n_iter = 441 
                      if (N == 25000)    n_iter = 442   
            } else   { 
                      if (N == 500)      n_iter = 923 *  5.0 * ceiling(  (32 / n_chains)  ) # target_ESS = 10,000
                      if (N == 1000)     n_iter = 260 * 5.0 * ceiling(  (32 / n_chains)  ) # target_ESS = 5000
                      if (N == 2500)     n_iter = 202 * 2.5 * ceiling(  (64 / n_chains)  ) # target_ESS = 2500
                      if (N == 5000)     n_iter = 452 * 2.5 * ceiling(  (64 / n_chains)  ) # target_ESS = 2500
                      if (N == 12500)    n_iter = 294 * 4 * ceiling(  (64 / n_chains)  ) # target_ESS = 1000
                      if (N == 25000)    n_iter = 393 * 4 * ceiling(  (64 / n_chains)  ) # target_ESS = 1000
            }
            
            n_iter <- round(n_iter, 0)
          ...
          } else if (run_type == "test_tau_target_method") {
              n_iter =  n_burnin
          } else if (run_type == "pilot_approx") { 
            n_iter =       1000
          }
